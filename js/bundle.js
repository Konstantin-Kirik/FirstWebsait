...
function calc(){
    ...
    if(localStorage.getItem('sex')){
        ...
        sex = 'femal';
        localStorage.setItem('sex', 'femal');
    }
    ...
    // функция позволяющая сохранить локальные данные пользователя 
...
function forms(formSelector, modalTimerId){
    // Forms
    // БУДЕМ ЗАПОЛНЯТЬ ФОРМУ ОБРАТНОЙ СВЯЗИ
    ...
    function bindPostData(form) {
        ...
        // отправка form смена формы заполнения на оповещение для пользователя
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function sliders({container, slide, nexArrow, prevArrow, totalCounter, currentCounter, wrapper, field}){
    // Slider
    // СОЗДАНИЕ СЛАЙДЕРА КАРТОЧЕК НА САЙТЕ
...
function timers(id, deadline){
    ...
    function getTimeRemaining(endtime) {
        ...
        //функция для подставления нуля для таймера
    function getZero(num){
        if (num >= 0 && num < 10) { 
         ...
         //устанавливаем наши часы через функцию
